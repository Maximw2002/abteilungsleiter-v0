...
import com.acme.abteilungsleiter.dev.DevConfig;
...
import static com.acme.abteilungsleiter.Banner.TEXT;
...
@Import({com.acme.abteilungsleiter.ApplicationConfig.class, DevConfig.class})
@ImportRuntimeHints(com.acme.abteilungsleiter.ApplicationConfig.CertificateResourcesRegistrar.class)
