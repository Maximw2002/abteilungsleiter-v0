...
class UriHelper {
    ...
    private static final String ABTEILUNGSLEITER_PREFIX = "/abteilungsleiter";
    ...
    private URI getBaseUriForwarded(final HttpServletRequest request, final String forwardedHost) {
        ...
        // x-forwarded-prefix: null bei Kubernetes Ingress Controller bzw. "/abteilungsleiter" bei Spring Cloud Gateway
        if(forwardedPrefix == null) {
            log.trace("getBaseUriForwarded: Kein '{}' im Header", X_FORWARDED_PREFIX);
            forwardedPrefix = ABTEILUNGSLEITER_PREFIX;
        }
