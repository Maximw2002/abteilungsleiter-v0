 ...
 */
package com.acme.abteilungsleiter;
...
import static com.acme.abteilungsleiter.security.Rolle.ACTUATOR;
import static com.acme.abteilungsleiter.security.Rolle.ADMIN;
import static com.acme.abteilungsleiter.security.Rolle.ABTEILUNGSLEITER;
...
interface SecurityConfig {
    ...
    /**
     * Bean, um Test-User anzulegen. Dazu gehören jeweils ein Benutzername, ein Passwort und diverse Rollen. Das wird in
     * Beispiel 2 verbessert werden.
    ...
    default UserDetailsService userDetailsService(final PasswordEncoder passwordEncoder) {
        final var users = List.of(
            User.withUsername("admin")
                ...
                .roles(ADMIN.name(), ABTEILUNGSLEITER.name(), ACTUATOR.name())
                .build()
        );
