...
import com.acme.abteilungsleiter.service.NotFoundException;
...
final class ExceptionHandler {
    ...
    GraphQLError onNotFound(final NotFoundException ex) {
        ...
        final var message = id == null
            ? STR."Kein Abteilungsleiter gefunden: suchkriterien=\{ex.getSuchkriterien()}"
            : STR."Kein Abteilungsleiter mit der ID \{id} gefunden";
