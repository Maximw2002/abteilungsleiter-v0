...
public class ConstraintViolationsException extends RuntimeException {
     ...
     */
    private final transient Collection<ConstraintViolation<Abteilungsleiter>> violations;

    ConstraintViolationsException(
        @SuppressWarnings("ParameterHidesMemberVariable") final Collection<ConstraintViolation<Abteilungsleiter>> violations
    ) {
