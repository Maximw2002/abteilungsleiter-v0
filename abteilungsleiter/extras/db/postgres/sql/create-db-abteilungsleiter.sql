...
-- (5) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-abteilungsleiter.sql
--        psql --dbname=abteilungsleiter --username=abteilungsleiter --file=/sql/create-schema-abteilungsleiter.sql
--        exit
--      docker compose down
...
CREATE ROLE abteilungsleiter LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE abteilungsleiter;

-- https://www.postgresql.org/docs/current/sql-grant.html
GRANT ALL ON DATABASE abteilungsleiter TO abteilungsleiter;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE abteilungsleiterspace OWNER abteilungsleiter LOCATION '/var/lib/postgresql/tablespace/abteilungsleiter';
