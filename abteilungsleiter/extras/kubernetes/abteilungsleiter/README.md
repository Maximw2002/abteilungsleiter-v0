...
Helm Chart für abteilungsleiter
...
| Name | Email | Url |
| ---- | ------ | --- |
| Maxim Weidler | <wema1123@h-ka.de> | <https://www.h-ka.de> |
...
| datasource.url | string | `"jdbc:postgresql://localhost/abteilungsleiter"` |  |
| datasource.username | string | `"abteilungsleiter"` |  |
...
| image.name | string | `"abteilungsleiter"` | Name des Image |
